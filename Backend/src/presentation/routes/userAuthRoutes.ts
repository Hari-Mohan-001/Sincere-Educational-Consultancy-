...
import { verifyUserToken } from "../../infrastructure/middlewre/verifyUserToken";
...
userAuthRoute.post("/signUp", (req: Request, res: Response) =>
  UserAuthController.signUp(req, res)
);
userAuthRoute.post("/verifyOtp", (req: Request, res: Response) =>
  UserAuthController.verifyOtp(req, res)
);
userAuthRoute.post("/signIn", (req: Request, res: Response) =>
  UserAuthController.signInUser(req, res)
);
userAuthRoute.post("/request-password-reset", (req: Request, res: Response) =>
  UserAuthController.passwordResetRequest(req, res)
);
userAuthRoute.post("/reset-password", (req: Request, res: Response) =>
  UserAuthController.resetPassword(req, res)
);
userAuthRoute.post("/google-auth", (req: Request, res: Response) =>
  UserAuthController.googleAuth(req, res)
);

userAuthRoute.use("/", (req:Request,res:Response, next:NextFunction)=>{
    verifyUserToken(req,res,next)
})
userAuthRoute.post("/signOut", (req: Request, res: Response) =>
