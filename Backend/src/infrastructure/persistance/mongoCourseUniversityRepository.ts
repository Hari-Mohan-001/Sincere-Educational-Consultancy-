...
export class mongoCourseUniversityRepository implements ICourseUniversityRepository{
    public async fetchAllUniversitiesForACourse(courseId: string): Promise<University[]> {
        try {
